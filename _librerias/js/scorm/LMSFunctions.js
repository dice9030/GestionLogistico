...
SCOState['Codigo'] = ''; //Scorm tracking id
SCOState['scorm_id'] = '';
SCOState['user_id'] = '';
SCOState['timestamp'] = '';
...
function LMSInitialize(parameter)
{
    ...
    try {
        ...
        if (_DEBUG)
            console.log("Function: LMSInitialize \nArgument: '" + parameter + "' \nReturnes: '" + return_value + "'");
...
function LMSFinish(parameter)
{
    ...
    try {
        ...
        if (_DEBUG)
            console.log("Function: LMSFinish \nArgument: '" + parameter + "' \nReturnes: '" + return_value + "'");
...
function LMSGetValue(parameter)
{
    ...
    if (_DEBUG)
        console.log("Function: LMSGetValue \nArgument: '" + parameter + "' \nReturns: '" + return_value + "'");
...
function LMSSetValue(parameter, value)
{
    ...
    if (_DEBUG)
        console.log("Function: LMSSetValue \nArgument: '" + parameter + "' \nSet Value: '" + value + "' \nReturns: '" + return_value + "'");
...
function LMSCommit(parameter)
{
    ...
    if (_DEBUG)
        console.log("Commit! Parameter: " + parameter + " Returnes value: " + return_value);
...
{
    if (_DEBUG)
        console.log("GetLastError: " + myErrorNumber);
...
{
    if (_DEBUG)
        console.log("LMSGetDiagnostic with errorNumber: " + errorNumber);
...
function myCommit(parameter)
{
    ...
    else
    {
        ...
        try {
            ...
            sendForm("/owlgroup/_vistas/gad_scorm.php?Tracking=save_step", 'scorm_form', handleCommit, "json");
...
function handleCommit(response) {
    //you need show the percent of progress
    console.log("success to save tracking data...");
