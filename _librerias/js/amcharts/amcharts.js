...
AmCharts.isModern = !0;
-1 != navigator.appVersion.indexOf("MSIE") && document.documentMode && (AmCharts.IEversion = Number(document.documentMode), 9 > AmCharts.IEversion && (AmCharts.isModern = !1));
AmCharts.dx = 0;
AmCharts.dy = 0;
    ...
    draw: function() {
        ...
        if (this.logarithmic && (0 >= this.getMin(0, this.data.length - 1) || 0 >= this.minimum))
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity ==
                ...
                var l = this.labelFrequency, m = this.showFirstLabel, n = this.showLastLabel, q = 1, p = 0, u = Math.round((this.max - this.min) / this.step) + 1, r;
                !0 === h ? (r = Math.log(this.max) * Math.LOG10E - Math.log(this.minReal) * Math.LOG10E, this.stepWidth = this.axisWidth / r, 2 < r && (u = Math.ceil(Math.log(this.max) * Math.LOG10E) + 1, p = Math.round(Math.log(this.minReal) * Math.LOG10E), u > this.gridCount && (q = Math.ceil(u / this.gridCount)))) : this.stepWidth = this.axisWidth / (this.max - this.min);
                var s = 0;
                ...
                A = !1;
                for (d = p; d < u; d += q)
                    E = AmCharts.roundTo(this.step * d + this.min, s), -1 != String(E).indexOf("e") &&
                ...
                for (d = p; d < u; d += q)
                    if (p = s * d + this.min, p = AmCharts.roundTo(p, this.maxDecCount + 1), !this.integersOnly || Math.round(p) == p)
                        if (isNaN(w) || Number(AmCharts.toFixed(p, w)) == p) {
                            !0 === h && (0 === p && (p = this.minReal), 2 < r && (p = Math.pow(10, d)), A = -1 != String(p).indexOf("e") ? !0 : !1);
                            this.useScientificNotation && (A =
                                    !0);
                            this.usePrefixes && (A = !1);
                            A ? (t = -1 == String(p).indexOf("e") ? p.toExponential(15) : String(p), c = t.split("e"), t = Number(c[0]), c = Number(c[1]), t = AmCharts.roundTo(t, 14), 10 == t && (t = 1, c += 1), t = t + "e" + c, 0 === p && (t = "0"), 1 == p && (t = "1")) : (h && (t = String(p).split("."), v.precision = t[1] ? t[1].length : -1), t = this.usePrefixes ? AmCharts.addPrefix(p, a.prefixesOfBigNumbers, a.prefixesOfSmallNumbers, v, !0) : AmCharts.formatNumber(p, v, v.precision));
                            this.duration && (t = AmCharts.formatDuration(p, this.duration, "", this.durationUnits, this.maxInterval,
                                    v));
                            ...
                            if (!isNaN(B) && 0 < E && d < u - 1) {
                                ...
                                for (c = 1; c < s / B; c++)
                                    x = this.getCoordinate(p + B * c), x = new this.axisItemRenderer(this, x, "", !1, 0, 0, !1, !1, 0, !0), this.pushAxisItem(x);
                                this.gridAlpha = t
                            }
                        }
                d = this.baseValue;
        ...
        "100% stacked" ==
                b && (b = "100%");
        this.stackType = b;
        var c = [], d = [], e = [], f = [], g, h = this.chart.graphs, k, l, m, n, q = this.baseValue, p = !1;
        ...
        for (k = this.start; k <= this.end; k++) {
            var u = 0;
            for (n = 0; n < h.length; n++)
                if (m = h[n], !m.hidden && (l = m.type, m.chart == this.chart && m.valueAxis == this && a == l && m.stackable && (l = this.data[k].axes[this.id].graphs[m.id],
                    ...
                    "regular" == b && (p && (isNaN(c[k]) ? (c[k] = g, l.values.close = g, l.values.open = this.baseValue) : (isNaN(g) ? l.values.close = c[k] : l.values.close = g + c[k], l.values.open = c[k], c[k] = l.values.close)), "column" != a || isNaN(g) || (l.values.close = g, 0 > g ? (l.values.close = g, isNaN(d[k]) ? l.values.open =
                            q : (l.values.close += d[k], l.values.open = d[k]), d[k] = l.values.close) : (l.values.close = g, isNaN(e[k]) ? l.values.open = q : (l.values.close += e[k], l.values.open = e[k]), e[k] = l.values.close)))
                }
        }
        for (k = this.start; k <= this.end; k++)
            for (n = 0; n < h.length; n++)
                m = h[n], m.hidden || (l = m.type, m.chart == this.chart && m.valueAxis == this && a == l && m.stackable && (l = this.data[k].axes[this.id].graphs[m.id], g = l.values.value, isNaN(g) || (c = 100 * (g / f[k]), l.values.percents = c, l.values.total = f[k], "100%" == b && (isNaN(d[k]) && (d[k] = 0), isNaN(e[k]) && (e[k] = 0),
        ...
        for (b = 0; b < a.length; b++) {
            ...
            if (c.valueAxis == this) {
                ...
                for (d = h; d <= g; d++) {
                    ...
                    var h = f.values, l;
                    for (l in h)
                        f.percents[l] = "percents" != l ? 100 * (h[l] / e) - 100 : h[l]
                }
            }
        }
    }, getMinMax: function() {
...
AmCharts.RecAxis = AmCharts.Class({construct: function(a) {
        var b = a.chart, c = a.axisThickness, d = a.axisColor, e = a.axisAlpha, f = a.offset, g = a.dx, h = a.dy, k = a.viX, l = a.viY, m = a.viH, n = a.viW, q = b.container;
        "H" == a.orientation ? (d = AmCharts.line(q, [0, n], [0, 0], d, e, c), this.axisWidth = a.width, "bottom" == a.position ? (a = c / 2 + f + m + l - 1, c = k) : (a = -c / 2 - f + l + h, c = g + k)) : (this.axisWidth = a.height, "right" == a.position ? (d = AmCharts.line(q, [0, 0, -g], [0, m, m - h], d, e, c), a = l + h, c = c / 2 + f + g + n + k - 1) : (d = AmCharts.line(q, [0, 0], [0, m], d, e, c), a = l, c = -c / 2 - f + k));
        d.translate(c,
                a);
        b.axesSet.push(d);
        this.set = d
...
AmCharts.RecItem = AmCharts.Class({construct: function(a, b, c, d, e, f, g, h, k, l) {
        ...
        var p = a.chart.container, u = p.set();
        this.set = u;
        ...
        "V" == Da && (B = 0);
        var y;
        I && (y = AmCharts.text(p, c, q, m, n, X, h), aa = y.getBBox().width);
        if ("H" == Da) {
            if (0 <= b && b <= U + 1 && (0 < v && 0 < w && b + k <= U + 1 && (W = AmCharts.line(p, [b + k, b + k], [0, v], s, w, A), u.push(W)), 0 < t && (X = AmCharts.line(p, [b, b + $, b + $], [O, O + V, V], E, t, A, x), u.push(X))), F = 0, G = b, g && 90 == B && (G -= n), !1 === d ? (X = "start", F = "bottom" == ca ? N ? F + v : F - v : N ? F - v : F + v, G += 3, e && (G += e / 2, X = "middle"), 0 < B && (X = "middle")) : X = "middle", 1 == ba && 0 < H && !g && !l && Y < U && (d = AmCharts.fitToBounds(b, 0, U), Y = AmCharts.fitToBounds(Y,
                    0, U), ha = d - Y, 0 < ha && (fill = AmCharts.rect(p, ha, a.height, z, H), fill.translate(d - ha + $, V), u.push(fill))), "bottom" == ca ? (F += O + n / 2 + na, N ? 0 < B ? (F = O - aa / 2 * Math.sin(ga) - v - 3, G += aa / 2 * Math.cos(ga)) : F -= v + n + 3 + 3 : 0 < B ? (F = O + aa / 2 * Math.sin(ga) + v + 3, G -= aa / 2 * Math.cos(ga)) : F += v + r + 3 + 3) : (F += V + n / 2 - na, G += $, N ? 0 < B ? (F = aa / 2 * Math.sin(ga) + v + 3, G -= aa / 2 * Math.cos(ga)) : F += v + 3 : 0 < B ? (F = -(aa / 2) * Math.sin(ga) - v - 6, G += aa / 2 * Math.cos(ga)) : F -= v + n + 3 + r + 3), "bottom" == ca ? ha = (N ? O - v - 1 : O + r - 1) + na : (ia = $, ha = (N ? V : V - v - r + 1) - na), f && (G += f), V = G, 0 < B && (V += aa / 2 * Math.cos(ga)),
                    y && (ca = 0, N && (ca = aa / 2 * Math.cos(ga)), V + ca > U + 2 || 0 > V))
                y.remove(), y = null
        } else {
            0 <= b && b <= O + 1 && (0 < v && 0 < w && b + k <= O + 1 && (W = AmCharts.line(p, [0, v], [b + k, b + k], s, w, A), u.push(W)), 0 < t && (X = AmCharts.line(p, [0, $, U + $], [b, b + V, b + V], E, t, A, x), u.push(X)));
            X = "end";
            if (!0 === N && "left" == ca || !1 === N && "right" == ca)
                X = "start";
            F = b - n / 2;
            1 == ba && 0 < H && !g && !l && (d = AmCharts.fitToBounds(b, 0, O), Y = AmCharts.fitToBounds(Y, 0, O), ga = d - Y, fill = AmCharts.polygon(p, [0, a.width, a.width, 0], [0, 0, ga, ga], z, H), fill.translate($, d - ga + V), u.push(fill));
            F += n / 2;
            "right" ==
...
AmCharts.AmChart = AmCharts.Class({construct: function() {
        ...
        if (b = this.backgroundImage)
            this.path && (b = this.path + b), this.bgImg = a = a.image(b, 0, 0, e, f), d.push(a)
    }, drawTitles: function() {
        var a = this.titles;
        ...
        if (AmCharts.VML || AmCharts.SVG)
            a = this.container, this.set = a.set(), this.gridSet = a.set(), this.graphsBehindSet = a.set(), this.bulletBehindSet = a.set(), this.columnSet =
        ...
        AmCharts.callMethod("clear", [this.chartScrollbar,
    ...
    drawLabel: function(a) {
        if (this.container) {
            ...
            void 0 === g && (g = 0);
            b += e / 2;
            c = AmCharts.text(this.container, c, f, this.fontFamily,
                    e, d, k, h);
            c.translate(l, b);
            0 !== g && c.rotate(g);
        ...
        var a = "", b = a + " ", c = "", d;
		// alert(d +" Diferencia "+ b);
        2 <= c.length && (d = c[c.length - 2] + "." + c[c.length - 1]);
        AmCharts.remove(this.bbset);
        if (d != b) {
            var b = b + "/?utm_source=swf&utm_medium=demo&utm_campaign=jsDemo" + a, e = " ", c = 145;
            "ammap" == a && (e = "tool by ", c = 125);
            d = AmCharts.rect(this.container, c,3, "#000",0);
            e = AmCharts.text(this.container, e + a + " ", "", "Verdana", 11, "start");
            e.translate(7, 9);
    ...
    validateSize: function() {
        ...
        var f = this.balloon;
        f.enabled && (f.followCursor(!1), f.changeColor(b), !c || f.fixedPosition ?
                (f.setPosition(d, e), f.followCursor(!1)) : f.followCursor(!0), a && f.showBalloon(a))
        ...
        if (this.mouseIsOver) {
            ...
            if (a) {
                ...
                a.touches && (a = a.touches.item(0), c = a.pageX - this.posX,
                        d = a.pageY - this.posY);
        ...
        for (a = this.animations.length - 1; 0 <= a; a--) {
            ...
            if (d <= c) {
                ...
                e.node.style[f] = Number(b.to) + b.suffix, this.animations.splice(a,
                        1)
        }
    }});
...
AmCharts.AmGraph = AmCharts.Class({construct: function() {
    ...
    createRadarGraph: function() {
        ...
        var k = this.width, l = this.height, m = this.y, n = this.rotate, q = this.columnCount, p = AmCharts.toCoordinate(this.cornerRadiusTop, h / 2), u = this.connect, r = [], s = [], w, v, t, A, E = this.chart.graphs.length,
        ...
        "above" == B && (B = "top");
        "below" == B && (B = "bottom");
        var ga = B, ha = this.getGradRotation(), G = this.chart.columnSpacing, F = V.cellWidth, ia = (F * h - q) / q;
        G > ia && (G = ia);
        ...
        if ("line" == g || "step" == g || "smoothedLine" == g) {
            if (0 < ba)
                for (P = ba - 1; - 1 < P; P--)
                    if (aa = d[P], y = aa.axes[f.id].graphs[b], Qa = y.values.value, !isNaN(Qa)) {
                        ba = P;
                        break
                    }
            if (N < d.length - 1)
                for (P = N + 1; P < d.length; P++)
                    if (aa = d[P], y = aa.axes[f.id].graphs[b], Qa = y.values.value, !isNaN(Qa)) {
                        N = P;
                        break
                    }
                ...
                switch (g) {
                    ...
                    case "column":
                        ...
                        if (!isNaN(R)) {
                            ...
                            if (!(R < ub && ja < ub || R > vb && ja > vb))
                                if (n) {
                                    "3d" == I ? (L = C - 0.5 * (h + G) + G / 2 +
                                            H * Y, K = Q + z * Y) : (L = C - (q / 2 - Y) * (h + G) + G / 2, K = Q);
                                    J = h;
                                    Z = D;
                                    fa = L + h / 2;
                                    pa = D;
                                    ...
                                    if (L < l && 0 < J && (la = new AmCharts.Cuboid(e, da, J, z - a.d3x, H - a.d3y, wa, Na, O, ka, U, ha, p, n, W, eb), "bottom" != B))
                                        if (B = f.reversed ? "left" : "right", 0 > R)
                                            B = f.reversed ? "right" : "left";
                                        else if ("regular" == I || "100%" == I)
                                            Z += this.dx
                                } else {
                                    "3d" == I ? (K = D - 0.5 * (h + G) + G / 2 + z * Y, L = M + H * Y) : (K = D - (q / 2 - Y) * (h + G) + G / 2, L = M);
                                    J = h;
                                    Z = K + h / 2;
                                    fa = C;
                                    pa = K + h / 2;
                                    ...
                                    if (K < k + Y * z && 0 < J)
                                        if (la = new AmCharts.Cuboid(e, J, da, z - a.d3x, H - a.d3y, wa, Na, O, ka, this.lineAlpha, ha, p, n, W, eb), 0 > R && "middle" != B)
                                            B = "bottom";
                                        else if (B = ga, "regular" == I || "100%" == I)
                                            fa += this.dy
                                }
                            if (la && (sa = la.set, sa.translate(K, L), this.columnsSet.push(sa), (y.url || this.showHandOnHover) && sa.setAttr("cursor", "pointer"), !$)) {
                                ...
                                if ("regular" == I || "100%" == I)
                                    B = "middle", x = n ? 0 < ta.value ? (this.end + 1 - P) * E + c : (this.end + 1 - P) * E - c : 0 < ta.value ? E * P + c : E * P - c;
                        ...
                        if (!isNaN(ja) && !isNaN(R)) {
                            ...
                            if (n) {
                                if (L = C - h / 2, K = Q, J = h, L + J > l && (J = l - L), 0 > L && (J += L, L = 0), L < l && 0 < J) {
                                    ...
                                    da = D - Q;
                                    la = new AmCharts.Cuboid(e, da, J, z, H, wa, Ia, O, ka, U, ha, p, n, W)
                                }
                            } else if (K = D - h / 2, L = M + O / 2, J = h, K + J > k && (J = k - K), 0 > K && (J += K, K = 0), da = C - M, K < k && 0 < J) {
                                var la = new AmCharts.Cuboid(e, J, da, z, H, wa, Na, O, ka, U, ha, p, n, W), jb, kb;
                                R > ja ? (jb = [C, Aa],
        ...
        if ("line" == g || "step" == g || "smoothedLine" == g)
            "smoothedLine" == g ? this.drawSmoothedGraph(r,
        ...
        if (1 < a.length) {
            ...
            var l = e.lineAlpha, m = e.lineThickness, f = e.fillAlphas, n = e.lineColor,
                    q = e.lineColorSwitched;
            q && (n = q);
            var q = e.fillColors, p = e.fillColorsSwitched;
            p && (q = p);
            var u = e.dashLength;
            (p = e.dashLengthSwitched) && (u = p);
            var p = e.negativeLineColor, r = e.negativeFillColors, s = e.negativeFillAlphas, w = e.baseCoord;
            0 !== e.negativeBase && (w = e.valueAxis.getCoordinate(e.negativeBase));
            n = AmCharts.line(g, a, b, n, l, m, u, !1, !0);
            h.push(n);
            h.click(function() {
                e.handleGraphClick()
            });
            void 0 !== p && (l = AmCharts.line(g, a, b, p, l, m, u, !1, !0), k.push(l));
            if (0 < f || 0 < s)
                if (l = a.join(";").split(";"), m = b.join(";").split(";"), "serial" ==
                        e.chartType && (0 < c.length ? (c.reverse(), d.reverse(), l = a.concat(c), m = b.concat(d)) : e.rotate ? (m.push(m[m.length - 1]), l.push(w), m.push(m[0]), l.push(w), m.push(m[0]), l.push(l[0])) : (l.push(l[l.length - 1]), m.push(w), l.push(l[0]), m.push(w), l.push(a[0]), m.push(m[0]))), 0 < f && (a = AmCharts.polygon(g, l, m, q, f, 0, 0, 0, this.gradientRotation), a.pattern(e.pattern), h.push(a)), r || void 0 !== p)
                    isNaN(s) && (s = f), r || (r = p), g = AmCharts.polygon(g, l, m, r, s, 0, 0, 0, this.gradientRotation), g.pattern(e.pattern), k.push(g), k.click(function() {
                        e.handleGraphClick()
                    });
            e.applyMask(k, h)
        }
        ...
        if (1 < a.length) {
            ...
            e.push(h);
            e.push(g);
            var k = this.lineAlpha, l = this.lineThickness, e = this.dashLength, m = this.fillAlphas, n = this.lineColor, q = this.fillColors, p = this.negativeLineColor, u = this.negativeFillColors, r = this.negativeFillAlphas, s = this.baseCoord, w = this.lineColorSwitched;
            w && (n = w);
            (w = this.fillColorsSwitched) && (q = w);
            n = new AmCharts.Bezier(f, a, b, n, k, l, q, 0, e);
            g.push(n.path);
            void 0 !== p && (k = new AmCharts.Bezier(f, a, b, p, k, l, q, 0, e), h.push(k.path));
            0 < m && (l = a.join(";").split(";"), n = b.join(";").split(";"), k = "", 0 < c.length ? (c.reverse(), d.reverse(), l = a.concat(c), n = b.concat(d)) : (this.rotate ? (k += " L" + s + "," + b[b.length - 1], k += " L" + s + "," + b[0]) : (k += " L" + a[a.length - 1] + "," + s, k += " L" + a[0] + "," + s), k += " L" + a[0] + "," + b[0]), c = new AmCharts.Bezier(f, l, n, NaN, 0, 0, q, m, e, k), c.path.pattern(this.pattern),
                    g.push(c.path), u || void 0 !== p) && (r || (r = m), u || (u = p), a = new AmCharts.Bezier(f, a, b, NaN, 0, 0, u, r, e, k), a.path.pattern(this.pattern), h.push(a.path));
            this.applyMask(h, g)
        }
        ...
        e = this.bullet;
        a.bullet && (e = a.bullet);
        var g = this.bulletBorderThickness, m = this.bulletBorderColor, n = this.bulletBorderAlpha, q = this.bulletAlpha;
        m || (m = l);
        var p = a.alpha;
        isNaN(p) || (q = p);
        if ("none" != this.bullet || a.bullet)
            k = AmCharts.bullet(d, e, f, l, q, g, m, n, h);
        if (this.customBullet || a.customBullet)
            h = this.customBullet, a.customBullet && (h = a.customBullet), h && (k && k.remove(), "function" == typeof h ? (k = new h, k.chart = this.chart, a.bulletConfig && (k.availableSpace = c, k.graph = this, a.bulletConfig.minCoord = this.minCoord - c, k.bulletConfig = a.bulletConfig), k.write(d),
                    k = k.set) : (this.chart.path && (h = this.chart.path + h), k = d.set(), d = d.image(h, 0, 0, f, f), k.push(d), this.centerCustomBullets && d.translate(-f / 2, -f / 2)));
        ...
        if (a) {
            var b =
                    this.chart, c = {type: "rollOverGraphItem", item: a, index: a.index, graph: this, target: this, chart: this.chart};
            ...
            if (c) {
                var c = b.formatString(this.balloonText, a, a.graph), d = this.balloonFunction;
                d && (c = d(a, a.graph));
                c = AmCharts.cleanFromEmpty(c);
                d = b.getBalloonColor(this, a);
                b.balloon.showBullet = !1;
                b.balloon.pointerOrientation =
                        "V";
                var e = a.x, f = a.y;
                b.rotate && (e = a.y, f = a.x);
                b.showBalloon(c, d, !0, e + b.marginLeftReal, f + b.marginTopReal)
            }
        }
        ...
        a && (a = {type: "doubleClickGraphItem", item: a, index: a.index,
            graph: this, target: this, chart: this.chart}, this.fire("doubleClickGraphItem", a), this.chart.fire("doubleClickGraphItem", a))
    }, zoom: function(a, b) {
        this.start = a;
        this.end = b;
        this.draw()
...
AmCharts.ChartCursor = AmCharts.Class({construct: function() {
        ...
        this.bulletsEnabled = this.skipZoomDispatch =
                !1;
        this.bulletSize = 8;
        ...
        var a = this.chart, b = this.cursorAlpha, c = a.categoryAxis, d = c.position, e = c.inside, f = c.axisThickness, g = this.categoryBalloon, h, k, l = a.dx, m = a.dy, n = this.x, q = this.y, p = this.width, u = this.height, a = a.rotate, r = c.tickLength;
        g.pointerWidth = r;
        a ? (h = [0, p, p + l], k = [0, 0, m]) : (h = [l, 0, 0], k = [m, 0, u]);
        this.line = b = AmCharts.line(this.container, h, k, this.cursorColor, b, 1);
        this.set.push(b);
        a ? (e && (g.pointerWidth = 0), "right" == d ? e ? g.setBounds(n, q + m,
                n + p + l, q + u + m) : g.setBounds(n + p + l + f, q + m, n + p + 1E3, q + u + m) : e ? g.setBounds(n, q, p + n, u + q) : g.setBounds(-1E3, -1E3, n - r - f, q + u + 15)) : (g.maxWidth = p, c.parseDates && (r = 0, g.pointerWidth = 0), "top" == d ? e ? g.setBounds(n + l, q + m, p + l + n, u + q) : g.setBounds(n + l, -1E3, p + l + n, q + m - r - f) : e ? g.setBounds(n, q, p + n, u + q - r) : g.setBounds(n, q + u + r + f - 1, n + p, q + u + r + f));
        this.hideCursor()
    ...
    destroyValueBalloons: function() {
        ...
        if (this.enabled) {
            void 0 ===
                    b && (b = !0);
            this.index = a;
            var f = c.categoryAxis, g = c.dx, h = c.dy, k = this.x, l = this.y, m = this.width, n = this.height, q = this.data[a];
            if (q) {
                var p = q.x[f.id], u = c.rotate, r = f.inside, s = this.stepWidth, w = this.categoryBalloon, v = this.firstTime, t = this.lastTime, A = this.cursorPosition, E = f.position, x = this.zooming, z = this.panning, H = c.graphs, I = f.axisThickness;
                if (c.mouseIsOver || x || z || this.forceShow)
                    if (this.forceShow = !1, z) {
                        ...
                        "start" == A && (p -= f.cellWidth / 2);
                        "mouse" == A && c.mouseIsOver && (p = u ? e - 2 : d - 2);
                        if (u) {
                            if (0 > p)
                                if (x)
                                    p = 0;
                        ...
                        0 < this.cursorAlpha && (v = this.line, u ? (t = 0, s = p + h) : (t = p, s = 0), A = this.animationDuration, 0 < A && !this.zooming ? isNaN(this.previousX) ? v.translate(t, s) : (v.translate(this.previousX, this.previousY), v.animate({translate: t + "," + s}, A, "easeOutSine")) : v.translate(t, s), this.previousX = t, this.previousY = s, v.show());
                        this.linePos = u ? p + h : p;
                        x && (u ? this.updateSelectionSize(NaN, p) : this.updateSelectionSize(p, NaN));
                        s = !0;
                        x && (s = !1);
                        this.categoryBalloonEnabled &&
                                s ? (u ? (r && ("right" == E ? w.setBounds(k, l + h, k + m + g, l + p + h) : w.setBounds(k, l + h, k + m + g, l + p)), "right" == E ? r ? w.setPosition(k + m + g, l + p + h) : w.setPosition(k + m + g + I, l + p + h) : r ? w.setPosition(k, l + p) : w.setPosition(k - I, l + p)) : "top" == E ? r ? w.setPosition(k + p + g, l + h) : w.setPosition(k + p + g, l + h - I + 1) : r ? w.setPosition(k + p, l + n) : w.setPosition(k + p, l + n + I - 1), (v = this.categoryBalloonFunction) ? w.showBalloon(v(q.category)) : f.parseDates ? (f = AmCharts.formatDate(q.category, this.categoryBalloonDateFormat), -1 != f.indexOf("fff") && (f = AmCharts.formatMilliseconds(f,
                                q.category)), w.showBalloon(f)) : w.showBalloon(q.category)) : w.hide();
                        H && this.bulletsEnabled && this.showBullets();
                        if (this.oneBalloonOnly) {
                            h = Infinity;
                            for (t = 0; t < H.length; t++)
                                f = H[t], f.showBalloon && !f.hidden && f.balloonText && (w = q.axes[f.valueAxis.id].graphs[f.id], v = w.y, isNaN(v) || (u ? Math.abs(d - v) < h && (h = Math.abs(d - v), B = f) : Math.abs(e - v) < h && (h = Math.abs(e - v), B = f)));
                            this.mostCloseGraph && (B = this.mostCloseGraph)
                        }
                        if (a != this.previousIndex || B != this.previousMostCloseGraph)
                            if (this.normalizeBulletSize(), this.destroyValueBalloons(),
                                ...
                                for (t = 0; t < H.length; t++)
                                    if (f = H[t], (!this.oneBalloonOnly || f == B) && f.showBalloon && !f.hidden && f.balloonText && (w = q.axes[f.valueAxis.id].graphs[f.id], v = w.y, !isNaN(v))) {
                                        r = w.x;
                                        s = !0;
                                        if (u) {
                                            if (p = v, 0 > r || r > n)
                                                s = !1
                                        } else if (p = r, r = v, 0 > p || p > m + g)
                                            s = !1;
                                        s && (1 != this.graphBulletSize && AmCharts.isModern && (s = w.bulletGraphics) && (s.getBBox(), s.translate(w.bx, w.by, this.graphBulletSize), this.resizedBullets.push(w)), s = f.valueBalloon,
                                                E = c.getBalloonColor(f, w), s.setBounds(k, l, k + m, l + n), s.pointerOrientation = "H", s.changeColor(E), void 0 !== f.balloonAlpha && (s.fillAlpha = f.balloonAlpha), void 0 !== f.balloonTextColor && (s.color = f.balloonTextColor), s.setPosition(p + k, r + l), p = c.formatString(f.balloonText, w, f), (r = f.balloonFunction) && (p = r(w, f)), "" !== p && (u ? s.showBalloon(p) : (s.text = p, s.show = !0)), !u && s.set && s.set.hide(), h.push({yy: v, balloon: s}))
                                    }
        ...
        if (a) {
            ...
            if (this.drawingNow) {
                ...
                if (2 < Math.abs(c - d) || 2 < Math.abs(f - e))
                    c = {type: "draw", target: this, chart: a, initialX: c, initialY: f, finalX: d,
            ...
            if (this.enabled && 0 < b.length) {
                if (this.pan)
                    ...
                    c.chart = a;
                    if ("cursor" == this.type)
                        this.rotate ? this.selectionPosY = e : this.selectionPosX = e = d, 2 > Math.abs(e - this.initialMouse) && this.fromIndex == this.index || (this.index < this.fromIndex ? (c.end = this.fromIndex, c.start = this.index) : (c.end = this.index, c.start = this.fromIndex), e = a.categoryAxis, e.parseDates && !e.equalSpacing &&
                                (c.start = b[c.start].time, c.end = a.getEndTime(b[c.end].time)), this.skipZoomDispatch || this.fire(c.type, c));
                    else {
        ...
        if (this.zoomable || this.pan || this.drawing) {
            ...
            if (0 < d && d < this.width && 0 < e && e < this.height || "fake" == a)
                this.setPosition(), this.selectWithoutZooming && AmCharts.remove(this.selection), this.drawing ?
...
AmCharts.SimpleChartScrollbar = AmCharts.Class({construct: function() {
        ...
        c = h.x + e;
        d = h.y + f;
        var k = h.width, h = h.height, l = this.rotate, m = this.chart, n = this.width, q = this.height, p = m.mouseX, u = m.mouseY;
        a = this.initialMouse;
        m.mouseIsOver && (this.dragging && (m = this.initialCoord, l ? (a = m + (u - a), 0 > a && (a = 0), m = q - h, a > m && (a = m), g.setAttr("y", a)) : (a = m + (p - a), 0 > a && (a = 0), m = n - k, a > m && (a = m), g.setAttr("x", a))), this.resizingRight &&
                (l ? (a = u - d, a + d > q + f && (a = q - d + f), 0 > a ? (this.resizingRight = !1, b = this.resizingLeft = !0) : (0 === a && (a = 0.1), g.setAttr("height", a))) : (a = p - c, a + c > n + e && (a = n - c + e), 0 > a ? (this.resizingRight = !1, b = this.resizingLeft = !0) : (0 === a && (a = 0.1), g.setAttr("width", a)))), this.resizingLeft && (l ? (c = d, d = u, d < f && (d = f), d > q + f && (d = q + f), a = !0 === b ? c - d : h + c - d, 0 > a ? (this.resizingRight = !0, this.resizingLeft = !1, g.setAttr("y", c + h - f)) : (0 === a && (a = 0.1), g.setAttr("y", d - f), g.setAttr("height", a))) : (d = p, d < e && (d = e), d > n + e && (d = n + e), a = !0 === b ? c - d : k + c - d, 0 > a ? (this.resizingRight =
                !0, this.resizingLeft = !1, g.setAttr("x", c + k - e)) : (0 === a && (a = 0.1), g.setAttr("x", d - e), g.setAttr("width", a)))), this.clipDragger(!0))
...
AmCharts.ChartScrollbar = AmCharts.Class({inherits: AmCharts.SimpleChartScrollbar, construct: function() {
        ...
        d.parseDates &&
                !d.equalSpacing && d.timeZoom(b.firstTime, b.lastTime);
        d.zoom(0, c.length - 1);
        if (l = a.graph) {
            var n = a.valueAxis, q = l.valueAxis;
            n.id = q.id;
            n.rotate = e;
            n.setOrientation(e);
            n.width = h;
            ...
            for (p = 0; p < c.length; p++) {
                var u = c[p].axes[q.id].graphs[l.id].values, r;
                for (r in u)
                    if (u.hasOwnProperty(r) && "percents" != r && "total" != r) {
                        var s = u[r];
                        s < f && (f = s);
                        s > g && (g = s)
                    }
        ...
        if (this.skipEvent)
            ...
            if (f.parseDates && !f.equalSpacing) {
                if (a = d.firstTime, f.minDuration(), d = Math.round(b / g) + a, a = this.dragging ? d + this.timeDifference : Math.round((b + c) / g) + a, d > a && (d = a), d != this.startTime || a != this.endTime)
                    ...
                    b)
                f.startOnAxis && (this.resizingRight && d == b && b++, this.resizingLeft && d == b && (0 < d ? d-- : b = 1)), this.start = d, this.end = this.dragging ? this.start + this.difference : b, e.start = this.start, e.end = this.end, f.parseDates && (a[this.start] && (e.startDate = new Date(a[this.start].time)), a[this.end] && (e.endDate = new Date(a[this.end].time))), this.fire(e.type, e)
        }
...
AmCharts.AmBalloon = AmCharts.Class({construct: function() {
        ...
        if (!isNaN(a)) {
            ...
            if (this.show) {
                var g = this.l, h = this.t, k = this.r, l = this.b, m = this.balloonColor,
                        n = this.fillColor, q = this.borderColor, p = n;
                void 0 != m && (this.adjustBorderColor ? p = q = m : n = m);
                ...
                E.position = "absolute";
                m.innerHTML = '<span style="font-size:' + A + "px; color:" + this.color + "; font-family:" + t + '">' + this.text + "</span>";
                ...
                A < g && (A = g);
                A + x > k && (A = k - x);
                var h = z + r, l = A + u, r = this.shadowAlpha, I = this.shadowColor, u = this.borderThickness, B = this.bulletSize,
                        ba;
                0 < v || 0 === s ? (0 < r && (a = AmCharts.rect(e, x, t, n, 0, u + 1, I, r, this.cornerRadius), AmCharts.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)), n = AmCharts.rect(e, x, t, n, this.fillAlpha, u, q, this.borderAlpha, this.cornerRadius), this.showBullet && (ba = AmCharts.circle(e, B, p, this.fillAlpha), f.push(ba))) : (p = [], v = [], "H" != w ? (g = a - A, g > x - s && (g = x - s), g < s && (g = s), p = [0, g - s, a - A, g + s, x, x, 0, 0], v = H ? [0, 0, b - z, 0, 0, t, t, 0] : [t, t, b - z, t, t, 0, 0, t]) : (p = b - z, p > t - s && (p = t - s), p < s && (p = s), v = [0, p - s, b - z, p + s, t, t, 0, 0], p = a < g + (k - g) / 2 ? [0, 0, A < a ? 0 : a - A, 0, 0,
                    x, x, 0] : [x, x, A + x > a ? x : a - A, x, x, 0, 0, x]), 0 < r && (a = AmCharts.polygon(e, p, v, n, 0, u, I, r), a.translate(1, 1), f.push(a)), n = AmCharts.polygon(e, p, v, n, this.fillAlpha, u, q, this.borderAlpha));
                this.bg = n;
                f.push(n);
                n.toFront();
                e = 1 * this.deltaSignX;
                ...
                0 < this.animationDuration && !d && !isNaN(this.prevX) && (f.translate(this.prevX, this.prevY), f.animate({translate: A - e + "," + z}, b,
                        "easeOutSine"), m && (E.left = this.prevTX + "px", E.top = this.prevTY + "px", this.xAnim = c.animate({node: m}, "left", this.prevTX, l, b, "easeOutSine", "px"), this.yAnim = c.animate({node: m}, "top", this.prevTY, h, b, "easeOutSine", "px")));
                this.prevX = A - e;
                this.prevY = z;
                this.prevTX = l;
                this.prevTY = h
        ...
        if (0 < b) {
            ...
            a.show = !1;
            var d = a.set;
            d && (d.setAttr("opacity", a.fillAlpha), d.animate({opacity: 0}, b, "easeInSine"));
            a.textDiv && c.animate({node: a.textDiv}, "opacity", 1, 0, b, "easeInSine", "")
        } else
            a.show = !1, a.follow = !1, a.destroy()
...
AmCharts.AmSlicedChart = AmCharts.Class({inherits: AmCharts.AmChart, construct: function() {
    ...
    setStartTO: function(a) {
        ...
        b && 0 < c && (0 < a.alpha && b.show(), b.translate(a.startX,
                a.startY), b.animate({opacity: a.alpha, translate: "0,0"}, c, this.startEffect))
    }, showLabels: function() {
        var a = this.chartData, b;
        for (b = 0; b < a.length; b++) {
            var c = a[b];
        ...
        var c = a.balloonX, d = a.balloonY;
        a.pulled && (c += a.pullX, d += a.pullY);
        var e = this.formatString(this.balloonText, a), f = AmCharts.adjustLuminosity(a.color, -0.15);
        this.showBalloon(e, f, b, c, d);
        c = {type: "rollOverSlice", dataItem: a, chart: this};
        this.fire(c.type, c)
    }, rollOutSlice: function(a) {
        isNaN(a) || (a = this.chartData[a]);
        a.wedge && a.wedge.attr({opacity: a.alpha});
        this.hideBalloon();
        a = {type: "rollOutSlice", dataItem: a,
            chart: this};
        this.fire(a.type, a)
        ...
        for (b = 0; b < a.length; b++) {
            var c = a[b];
            if (c.label) {
                var d = c.ty, d = AmCharts.line(this.container,
                        [c.tx0, c.tx, c.tx2], [c.ty0, d, d], this.labelTickColor, this.labelTickAlpha);
                c.tick = d;
                c.wedge.push(d)
            }
        }
        ...
        1 == b ?
                (a.pulled = !0, this.pullOutOnlyOne && this.pullInAll(a.index), a = {type: "pullOutSlice", dataItem: a, chart: this}) : (a.pulled = !1, a = {type: "pullInSlice", dataItem: a, chart: this});
        this.fire(a.type, a)
        ...
        if (void 0 !== b) {
            ...
            for (e = b = 0; e < c; e++)
                f = a[e], f.percents = 100 * (f.value / d), f.percents < this.groupPercent && b++;
        ...
        for (c = 0; c < a.length; c++) {
            var d = this.formatString(this.labelText, a[c]), d = AmCharts.text(this.container, d, this.color, this.fontFamily,
                    this.fontSize), e = d.getBBox().width;
            e > b && (b = e);
            d.remove()
        }
        return b
...
AmCharts.AmRectangularChart = AmCharts.Class({inherits: AmCharts.AmCoordinateChart, construct: function() {
        ...
        if (a = this.categoryAxis)
            b = this.getAxisBounds(a, g, k, h, b), g = b.l, k = b.r, h = b.t, b = b.b;
...
AmCharts.TrendLine = AmCharts.Class({construct: function() {
        ...
        var a = this;
        a.destroy();
        var b = a.chart, c = b.container, d, e, f, g, h = a.categoryAxis, k = a.initialDate, l = a.initialCategory, m = a.finalDate, n = a.finalCategory, q = a.valueAxis, p = a.valueAxisX, u = a.initialXValue, r = a.finalXValue, s = a.initialValue, w = a.finalValue, v = q.recalculateToPercents, t = b.dataDateFormat;
        h && (k && (k instanceof
        ...
        p && !v && (isNaN(u) || (d = p.getCoordinate(u)), isNaN(r) || (e = p.getCoordinate(r)));
        q && !v && (isNaN(s) || (f = q.getCoordinate(s)), isNaN(w) || (g = q.getCoordinate(w)));
...
AmCharts.makeHD = function(a, b, c) {
    for (var d = [], e = [], f = 1; f < a.length; f++)
        for (var g = Number(a[f - 1]), h = Number(b[f - 1]), k = Number(a[f]), l = Number(b[f]), m = Math.sqrt(Math.pow(k - g, 2) + Math.pow(l - h, 2)), m = Math.round(m / 50) + 1, k = (k - g) / m, l = (l - h) / m, n = 0; n <= m; n++) {
            var q = g + n * k + Math.random() * c, p = h + n * l + Math.random() * c;
            d.push(q);
            e.push(p)
        }
    return[d, e]
...
AmCharts.handDrawnLine = function(a, b, c, d, e, f, g, h, k, l, m) {
    ...
    for (m = 1; m < b.length; m++)
        for (var q = [b[m - 1], b[m]], p = [c[m - 1], c[m]], p = AmCharts.makeHD(q, p, a.handDrawScatter), q = p[0], p = p[1], u = 1; u < q.length; u++)
            n.push(AmCharts.line(a, [q[u - 1], q[u]], [p[u - 1], p[u]], d, e, f + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, g, h, k, l, !0));
    return n
};
...
AmCharts.wedge = function(a, b, c, d, e, f, g, h, k, l, m, n) {
    ...
    g = q(g);
    h = q(h);
    var p = q(g / f * h), u = AmCharts.VML, r = 359.5 + f / 100;
    359.94 < r && (r = 359.94);
    e >= r && (e = r);
    var s = 1 / 180 * Math.PI, r = b + Math.sin(d * s) * h, w = c - Math.cos(d * s) * p, v = b + Math.sin(d * s) * f, t = c - Math.cos(d * s) * g, A = b + Math.sin((d + e) * s) * f, E = c - Math.cos((d + e) * s) * g, x = b + Math.sin((d + e) * s) * h, s = c - Math.cos((d + e) * s) * p, z = {fill: AmCharts.adjustLuminosity(l.fill, -0.2), "stroke-opacity": 0}, H = 0;
    180 < Math.abs(e) && (H = 1);
    d = a.set();
    var I;
    u && (r = q(10 * r), v = q(10 * v), A = q(10 *
            A), x = q(10 * x), w = q(10 * w), t = q(10 * t), E = q(10 * E), s = q(10 * s), b = q(10 * b), k = q(10 * k), c = q(10 * c), f *= 10, g *= 10, h *= 10, p *= 10, 1 > Math.abs(e) && 1 >= Math.abs(A - v) && 1 >= Math.abs(E - t) && (I = !0));
    e = "";
    var B;
    0 < k && (u ? (B = " M" + r + "," + (w + k) + " L" + v + "," + (t + k), I || (B += " A" + (b - f) + "," + (k + c - g) + "," + (b + f) + "," + (k + c + g) + "," + v + "," + (t + k) + "," + A + "," + (E + k)), B += " L" + x + "," + (s + k), 0 < h && (I || (B += " B" + (b - h) + "," + (k + c - p) + "," + (b + h) + "," + (k + c + p) + "," + x + "," + (k + s) + "," + r + "," + (k + w)))) : (B = " M" + r + "," + (w + k) + " L" + v + "," + (t + k) + (" A" + f + "," + g + ",0," + H + ",1," + A + "," + (E + k) + " L" +
            x + "," + (s + k)), 0 < h && (B += " A" + h + "," + p + ",0," + H + ",0," + r + "," + (w + k))), B += " Z", B = a.path(B, void 0, void 0, "1000,1000").attr(z), d.push(B), B = a.path(" M" + r + "," + w + " L" + r + "," + (w + k) + " L" + v + "," + (t + k) + " L" + v + "," + t + " L" + r + "," + w + " Z", void 0, void 0, "1000,1000").attr(z), k = a.path(" M" + A + "," + E + " L" + A + "," + (E + k) + " L" + x + "," + (s + k) + " L" + x + "," + s + " L" + A + "," + E + " Z", void 0, void 0, "1000,1000").attr(z), d.push(B), d.push(k));
    u ? (I || (e = " A" + q(b - f) + "," + q(c - g) + "," + q(b + f) + "," + q(c + g) + "," + q(v) + "," + q(t) + "," + q(A) + "," + q(E)), f = " M" + q(r) + "," + q(w) +
            " L" + q(v) + "," + q(t) + e + " L" + q(x) + "," + q(s)) : f = " M" + r + "," + w + " L" + v + "," + t + (" A" + f + "," + g + ",0," + H + ",1," + A + "," + E) + " L" + x + "," + s;
    0 < h && (u ? I || (f += " B" + (b - h) + "," + (c - p) + "," + (b + h) + "," + (c + p) + "," + x + "," + s + "," + r + "," + w) : f += " A" + h + "," + p + ",0," + H + ",0," + r + "," + w);
...
AmCharts.AmDraw = AmCharts.Class({construct: function(a, b, c, d) {
        ...
        AmCharts.VML && (e = 100 * e / Math.min(c, d), c += 2 * f, d += 2 * f, h.bw = f, h.node.style.marginLeft =
...
AmCharts.VMLRenderer = AmCharts.Class({construct: function(a, b) {
        ...
        for (e =
            ...
            "Z" == g && (a += " x e");
            if ("Q" == g) {
                var l = c.length, m = c[l - 1], n = h[0], q = h[1], k = h[2], p = h[3];
                c = d(c[l - 2] / 3 + 2 / 3 * n);
                m = d(m / 3 + 2 / 3 * q);
                n = d(2 / 3 * n + k / 3);
                q = d(2 / 3 * q + p / 3);
...
AmCharts.SVGRenderer = AmCharts.Class({construct: function(a) {
        ...
        "translate" == b ? (f = (f = f.getAttribute("transform")) ? String(f).substring(10, f.length - 1) : "0,0", f =
                f.split(", ").join(" "), f = f.split(" ").join(","), 0 === f && (f = "0,0")) : f = f.getAttribute(b);
        ...
        for (a = b.length - 1; 0 <= a; a--) {
            ...
            e <= d ? (c.frame++, "translate" == g ? (h = c.from.split(","), g = Number(h[0]), h = Number(h[1]), isNaN(h) && (h = 0), k = c.to.split(","), l = Number(k[0]), k = Number(k[1]), l = 0 === l - g ? l : Math.round(AmCharts[c.effect](0,
                    e, g, l - g, d)), c = 0 === k - h ? k : Math.round(AmCharts[c.effect](0, e, h, k - h, d)), g = "transform", c = "translate(" + l + "," + c + ")") : (h = Number(c.from), l = Number(c.to), l -= h, c = AmCharts[c.effect](0, e, h, l, d), 0 === l && this.animations.splice(a, 1)), this.setAttr(f, g, c)) : ("translate" == g ? (k = c.to.split(","), l = Number(k[0]), k = Number(k[1]), f.translate(l, k)) : (l = Number(c.to), this.setAttr(f, g, l)), this.animations.splice(a, 1))
        }
    }, getBBox: function(a) {
        if (a = a.node)
            try {
        ...
        var d = new AmCharts.AmDObject("text",
                this.D);
        a = String(a).split("\n");
        var e = b["font-size"], f;
        for (f = 0; f < a.length; f++) {
        ...
        c = "#";
        AmCharts.baseHref && !AmCharts.isIE && (c = window.location.href +
                c);
...
AmCharts.AmLegend = AmCharts.Class({construct: function() {
        ...
        this.titleWidth =
                0;
        if (b = this.title)
            a = AmCharts.text(this.container, b, this.color, a.fontFamily, this.fontSize, "start", !0), a.translate(this.marginLeft, this.marginTop + this.verticalGap + this.ly + 1), a = a.getBBox(), this.titleWidth = a.width + 15, this.titleHeight = a.height + 6;
        ...
        var a = this.position, b = this.marginLeft +
                this.titleWidth, c = this.marginRight, d = this.marginTop, e = this.marginBottom, f = this.horizontalGap, g = this.div, h = this.divWidth, k = this.maxColumns, l = this.verticalGap, m = this.spacing, n = h - c - b, q = 0, p = 0, u = this.container, r = u.set();
        this.set = r;
        u = u.set();
        r.push(u);
        ...
        for (v = 0; v < s.length; v++) {
            ...
            w = x.getBBox();
            var z;
            this.equalWidths ? z = f + A * (q + m + this.markerLabelGap) :
                    (z = E, E = E + w.width + f + m);
        ...
        if (!1 !== a.visibleInLegend) {
            ...
            if (this.useGraphSettings)
                ...
                h ? (b.path && (h = b.path + h), g = k.image(h, 0, 0, l, l)) : (g = this.createMarker(c, d, e, void 0, void 0, void 0, void 0, g)) && g.translate(l / 2, l / 2);
            this.addListeners(g, a);
            k = k.set([g]);
            this.switchable && k.setAttr("cursor", "pointer");
            if (f = this.switchType)
                n = "x" == f ? this.createX() : this.createV(), n.dItem = a, !0 !== a.hidden ? "x" == f ? n.hide() : n.show() : "x" != f && n.hide(), this.switchable || n.hide(), this.addListeners(n,
            ...
            var q;
            d && (d = AmCharts.fixNewLines(d), a.legendTextReal = d, q = AmCharts.text(this.container, d, f, b.fontFamily, n, "start"), q.translate(this.lx + m, this.ly), k.push(q), b = q.getBBox().width,
