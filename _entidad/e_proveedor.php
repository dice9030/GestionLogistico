...
if (get("metodo") != ""){
    ...
    if(get("TipoDato") == "texto"){
        if(get("transaccion") == "UPDATE"){
            ...
            if(get("metodo") == "FProveedor"){p_gf("FProveedor",$CN,$CodigoProveedor);Proveedor("Listado");}            
         }

        if(get("transaccion") == "INSERT"){
            if(get("metodo") == "FProveedor"){p_gf("FProveedor",$CN,"");Proveedor("Listado");}
...
function Proveedor($Arg){
    ...
    switch ($Arg) {
        case "Listado":
            ...
            $sql = "SELECT Nombre,ApellidoPaterno,RazonSocial,Codigo AS CodigoAjax FROM maproveedor ";
        ...
        case "Crear":
            ...
            $tSelectD = array(
                'Distritos'  => 'SELECT Codigo,Descripcion FROM madistritos'                        
            );

            $uRLForm = "Guardar]".$enlace."?metodo=FProveedor&transaccion=INSERT]optionbody]F]}";
            $form = c_form_adp('', $CN,'FProveedor', 'CuadroA', $path, $uRLForm, "", $tSelectD,'Codigo');
        ...
        case "Editar":
            ...
            $form = c_form_adp('',$CN,'FProveedor', 'CuadroA', $path, $uRLForm, $CodigoProveedor, $tSelectD,'Codigo');
