...
if (get("metodo") != ""){
    ...
    if(get("TipoDato") == "texto"){
        if(get("transaccion") == "UPDATE"){
            ...
            if(get("metodo") == "FCategoriaProducto"){p_gf("FCategoriaProducto",$CN,$CodigoTC);CategoriaProductos("Listado");}            
         }

        if(get("transaccion") == "INSERT"){
            if(get("metodo") == "FCategoriaProducto"){p_gf("FCategoriaProducto",$CN,"");CategoriaProductos("Listado");}
...
function CategoriaProductos($Arg){
    ...
    switch ($Arg) {
        ...
        case "Crear":
            ...
            $form = c_form_L('',$CN,'FCategoriaProducto', 'CuadroA', $path, $uRLForm, "", $tSelectD,'Codigo');
        ...
        case "Editar":
            ...
            $form = c_form_adp('', $CN,'FCategoriaProducto', 'CuadroA', $path, $uRLForm, $CodigoTC, $tSelectD,'Codigo');
            $form = "<div style='width:100%;'>".$btn.$form."</div>";
            $s = "<div class= 'PanelPadding'>".$form."</div>";             
            WE($s);
        break;    
